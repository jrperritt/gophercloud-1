...
import (
	...
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/blockstorage"
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/compute"
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/files"
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/identity"
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/images"
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/loadbalancing"
	"github.com/gophercloud/gophercloud/internal/cli/openstack/commands/networking"
	"github.com/gophercloud/gophercloud/internal/cli/setup"
...
var commands = []cli.Command{
	...
	{
		Name:        "identity",
		Usage:       "Roles, projects, users and tokens",
		Subcommands: identity.Get(),
	},
}
