...
func TestAbandonPreTable(t *testing.T) {
	...
	resource.Result = &osStacks.AbandonedStack{
		...
		Files: map[string]string{
			"file:///Users/prat8228/go/src/github.com/gophercloud/cli/my_nova.yaml": "heat_template_version: 2014-10-16\nparameters:\n  flavor:\n    type: string\n    description: Flavor for the server to be created\n    default: 4353\n    hidden: true\nresources:\n  test_server:\n    type: \"OS::Nova::Server\"\n    properties:\n      name: test-server\n      flavor: 2 GB General Purpose v1\n image: Debian 7 (Wheezy) (PVHVM)\n",
		},
		...
		Environment: map[string]interface{}{
			...
			"resource_registry": map[string]interface{}{
				"file:///Users/prat8228/go/src/github.com/gophercloud/cli/my_nova.yaml": "file:///Users/prat8228/go/src/github.com/gophercloud/cli/my_nova.yaml",
