...
type Resource struct {
	stdinField string
	// StdInParams will be the user-provided value to STDIN, if any.
...
/*
func (r *Resource) SetResult(resulter lib.Resulter) {
	r.result = resulter
}

func (r Resource) Result() lib.Resulter {
	return r.result
}
*/

func (r *Resource) StdinValue() interface{} {
	return r.stdinValue
}

func (r *Resource) SetStdinValue(v interface{}) {
	r.stdinValue = v
}

func (r *Resource) StdinField() string {
	return r.stdinField
}

func (r *Resource) SetStdinField(f string) {
	r.stdinField = f
}
